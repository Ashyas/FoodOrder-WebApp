...
namespace WebApp.Pages.Admin.Order
{
    public class OrderDetailsModel : PageModel
    {
        ...
        public OrderDetail_VM orderDetail_VM { get; set; }
        ...
        {
            _unitOfWork.OrderHeader.UpdateStatus(orderId, StaticDetail.StatusCompleted);
            _unitOfWork.Save();
        ...
        public IActionResult OnPostOrderRefund(int orderId)
        {
            ...
            _unitOfWork.OrderHeader.UpdateStatus(orderId, StaticDetail.StatusRefunded);
            _unitOfWork.Save();
            return RedirectToPage("OrderList");
        }
